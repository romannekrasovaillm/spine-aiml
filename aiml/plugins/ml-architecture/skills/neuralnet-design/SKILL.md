...
Память среды (VRAM/OOM/ABI-инциденты): `~/.claude/projects/<слаг-рабочего-каталога>/memory/`
(слаг — абсолютный путь рабочего каталога, в котором каждый символ вне `[A-Za-z0-9]`
заменён на `-`) —
