...
/// Снятие ANSI/управляющих последовательностей — общий низкоуровневый
/// `crate::ansi::strip` (вынесен из TUI: разбор контрактов в harness.rs —
/// нижний слой, правило no-tui-below-ui). Алиас держим ради вызовов TUI.
